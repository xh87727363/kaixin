...
public class ArticlesRecycleViewAdapter extends RecycleViewBaseAdapter<ResponseMainListData.DataBean.ArticlesBean> {
    public ArticlesRecycleViewAdapter(Context context) {
        super(context);
    }
